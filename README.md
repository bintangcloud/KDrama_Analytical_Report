# 📊 K-Drama Analytics: Trends & Viewer Preferences

> **Project Status:** *Completed (Final Project)* ✅

Repository ini berisi dokumentasi akhir dari proyek analisis data Drama Korea. Proyek ini bertujuan mengungkap faktor-faktor kunci kesuksesan sebuah drama (Rating) melalui analisis statistik dan visualisasi data.

## 📂 Project Structure
* **`Analytical Report.pdf`** 📄: Laporan lengkap berisi temuan utama, visualisasi, dan rekomendasi strategis (Slide Presentasi).
* **`Exploratory Data Analysis (EDA) dan Visualisasi Data.xlsx`** 📗: Workbook kerja berisi proses Pivot Tables dan Charts.
* **`Statistik Dasar & Data Cleaning.xlsx`** 💾: Workbook kerja berisi proses Data Cleaning dan Statistik Dasar
...
* **Data Processing:** Microsoft Excel (Power Query, Text Functions).
* **Analysis:** Pivot Tables, Descriptive Statistics.
* **Visualization:** Excel Charts (Bar, Line, Scatter, Pie).
